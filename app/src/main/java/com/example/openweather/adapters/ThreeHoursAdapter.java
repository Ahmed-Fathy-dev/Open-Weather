...
public class ThreeHoursAdapter extends RecyclerView.Adapter<ThreeHoursAdapter.ViewHolder> {
    ...
    public ThreeHoursAdapter(List<WeatherList> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public ThreeHoursAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ThreeHoursAdapter.ViewHolder holder, int position) {
