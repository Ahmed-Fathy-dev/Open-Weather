...
public class FiveDayAdapter extends RecyclerView.Adapter<FiveDayAdapter.ViewHolder> {
    ...
    public FiveDayAdapter(List<WeatherList> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public FiveDayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FiveDayAdapter.ViewHolder holder, int position) {
