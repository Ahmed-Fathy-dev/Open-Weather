...
import com.example.openweather.adapters.FiveDayAdapter;
import com.example.openweather.adapters.ThreeHoursAdapter;
...
public class CityFragment extends Fragment {
    ...
    ThreeHoursAdapter threeHoursAdapter;

    FiveDayAdapter fiveDayAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        threeHoursAdapter = new ThreeHoursAdapter(weatherList, getContext());
        fiveDayAdapter = new FiveDayAdapter(weatherLists, getContext());
        //feels_like
        ...
        int cityId;
        cityId = intent.getIntExtra("id", 360630);
        ...
        weatherModelCall.enqueue(new Callback<WeatherModel>() {
            ...
            public void onResponse(@NotNull Call<WeatherModel> call, @NotNull Response<WeatherModel> response) {
                ...
                threeHoursAdapter.setList(weatherModel.getList());
                fiveDayAdapter.setList(weatherModel.getList());
            }
    ...
    //Intent method that get the position of the views from the API
    ...
    /**
     * Return the formatted date string ( "Oct 1, 1989") from a Date object.
     */
    ...
    /**
     * Return the formatted date string ("4:30 PM") from a Date object.
     */
